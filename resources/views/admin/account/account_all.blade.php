...
@section('admin')
@section('Title', 'Account  Management  | HC Gaming Studio')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Account Management</h4>

<a href="#" class="btn btn-danger btn-rounded waves-effect waves-light empty-cart-btn">Invite New Member</a>
        ...
        @endforeach
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title mb-2" > All Account Data</h4>
...
{{--
                            ...
                            <td>
                                ...
                                {{ $item->commissions->sum('commission_amount') }}
                            @else
                                0
                            @endif
                            </td>
                            ...
                            <td>
                                ...
                                @if(Auth::user()->id !== $item->id)
                                    <a href="{{ route('edit.account', $item->id) }}" class="" title="Edit Data">
