...
<title>Traders Management | HC Gaming Studio</title>
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Traders Management</h4>
        ...
        @endforeach
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title mb-2" > All Traders Data</h4>

                    <div class="row text-center " >

                        <div class="row">
                            <div class="col-md-4 col-sm-12 border border-dark pt-3 mb-3">
                                <h5 class="mb-0">{{ $tradersCount }}</h5>
...
{{--
                            ...
                            <td>
                                ...
                                @if(Auth::user()->id !== $item->id)
                                    <a href="{{ route('edit.traders.account', $item->id) }}" class="" title="Edit Data">
