...
<title>New Notification | HC Gaming Studio</title>
        ...
        <div class="row mb-3">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">New Notification</h4>
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.notifications.store') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="type" id="type" class="form-control" value="{{ old('type', 'general') }}" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="url" name="action_url" id="action_url" class="form-control" value="{{ old('action_url') }}" placeholder="https://...">
                            </div>
                            <div class="mb-4">
                                    ...
                                    @foreach($roleOptions as $role)
                                        <div class="col-md-4 mb-2">
                                            <label class="form-check">
                                                <input type="checkbox" name="target_roles[]" value="{{ $role->id }}" class="form-check-input" {{ in_array($role->id, old('target_roles', [])) ? 'checked' : '' }}>
