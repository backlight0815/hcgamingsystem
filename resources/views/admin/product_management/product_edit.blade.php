...
<div class="category">
                    ...
                    <select name="product_category_id" class="form-select" id="product_category" aria-label="Default select example">
                        <option value="" {{ $product->product_category_id == null ? 'selected' : '' }}>--Open this select menu--</option>
                        @foreach($categories as $cat)
                            @if(!$cat->trashed())
                                <option value="{{ $cat->id }}" {{ $cat->id == $product->product_category_id ? 'selected' : '' }}>{{ $cat->product_category }}
