...
<title>Portfolio Management | HC Gaming Studio</title>
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Portfolio Management</h4>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title mb-2" > All Portfolio Data</h4>

                    <div class="row text-center " >
                        <div class="col-4 border border-dark pt-3 ">
                            <h5 class="mb-0">{{ $portfolio_index }}</h5>
                            <p class="text-muted text-truncate">Trading Succesful No</p>
                        </div>
                        {{-- <div class="col-4 border border-dark pt-3">
