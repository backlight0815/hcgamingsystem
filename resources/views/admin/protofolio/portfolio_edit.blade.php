...
<title>Portfolio Management - Edit| HC Gaming Studio</title>
...
<input type="hidden" name="id" value="{{ $portfolio->id }}">
                ...
                <!-- end row -->
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <img id="showImages" class="rounded avatar-lg" src="{{ asset($portfolio->portfolio_image)}}" alt="Card image cap">
                            </div>
                        </div>
                        <!-- end row -->
