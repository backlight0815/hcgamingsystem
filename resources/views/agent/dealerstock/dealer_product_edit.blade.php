...
<title>Edit Dealer Product | HC Gaming Studio</title>
    ...
    <div class="container-fluid commerce-page">
        <section class="commerce-hero">
            <div>
                ...
                <h1>Edit Dealer Product</h1>
                <p>Update your dealer listing before publication, including stock, price, customer price, category, SKU, and image.</p>
            </div>
        ...
        <section class="commerce-panel">
            <div class="commerce-panel__header">
                <div>
                    ...
                    <p class="commerce-panel__subtitle">Editing dealer stock #{{ $product->id }}. Keep product details clear before publishing to buyers.</p>
                </div>
            </div>

            <form method="POST" action="{{ route('update.dealer.product') }}" id="submitDealerProduct" enctype="multipart/form-data" class="commerce-form-grid">
                @csrf
                ...
                <div class="commerce-form-section">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control" type="number" min="0" value="{{ old('product_stock', $product->product_stock) }}" id="stock" name="product_stock" required>
                            @error('product_stock')<span class="text-danger">{{ $message }}</span>@enderror
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="weight">Weight (KG)</label>
                            <input class="form-control" type="number" min="0" step="0.01" value="{{ old('weight', $product->weight) }}" id="weight" name="weight" required>
                ...
                <aside class="commerce-preview">
                    ...
                    <div class="commerce-preview__body">
                        <strong>Current Dealer Listing Image</strong>
                        <p class="commerce-muted mb-0">This image will be shown in the ecommerce catalogue after publication.</p>
                    </div>
                </aside>
            </form>
        </section>
...
<script>
    (function () {
        ...
        var form = document.getElementById('submitDealerProduct');
