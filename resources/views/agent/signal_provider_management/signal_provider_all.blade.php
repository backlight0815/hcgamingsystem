...
<title>Signal Provider Management | HC Gaming Studio</title>
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Signal Provider Management</h4>
                                         @if(feature_enabled('referral_signal_provider'))

                <a href="#" class="btn btn-danger btn-rounded waves-effect waves-light empty-cart-btn">Invite New Signal Provider</a>
                   @else
@endif
                    ...
                    <div class="row text-center " >
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-12 border border-dark pt-3 mb-3">
                                <h5 class="mb-0">{{ $signalProviderCount }}</h5>
                            <p class="text-muted text-truncate">Total of Signal Provider</p>
                        </div>
                        <div class="col-md-4 col-sm-12 border border-dark pt-3 mb-3">
                            <h5 class="mb-0">{{ $activeCustomer }}</h5>
                            <p class="text-muted text-truncate">No Active Signal Provider</p>
                        </div>
                        <div class="col-md-4 col-sm-12 border border-dark pt-3 mb-3">
                            <h5 class="mb-0">{{ $inactiveCustomer }}</h5>
                            <p class="text-muted text-truncate">No Inactive Signal Provider</p>
                        </div>
...
<div class="table-responsive">
                    <table id="datatable" class="table table-bordered" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                        ...
                        <input type="hidden" id="dynamicReferralCode" value="{{ Auth::user()->signal_provider_referral_code ?? '' }}">
                        <thead>
                        <tr>
                            <th>SI</th>
                            <th>Username</th>
                        ...
                        <tbody>
                            @php($i=1)
                            @foreach($providersUsers as $item)
                        <tr>
                            <td>{{ $i++ }}</td>
