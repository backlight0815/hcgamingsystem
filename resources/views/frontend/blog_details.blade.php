...
@section('title')
Blog-Details | HC_Gaming Studio Websites
    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="standard__blog__post">
                ...
                <p><b>View Count:</b>{{ $blogs->page_views }}</p>
...
@endforeach
                ...
                <div class="widget">
                    ...
                    <ul class="sidebar__cat">
                        ...
                        <li class="sidebar__cat__item"><a href={{ route('category.blog',$cat->id) }}>

                            @if ($cat['category'] && !$cat['category']->trashed())
                            {{ $cat['category']['blog_category'] }}
                        @else
