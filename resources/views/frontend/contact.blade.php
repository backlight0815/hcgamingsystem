...
@section('title')
Contact | HC_Gaming Studio Websites
...
<main>
    ...
    <form method="POST" action="{{ route('store.message') }}" class="contact__form">
        ...
        <div class="row" >
            ...
            <div class="col-md-6" style="border:solid">
                <input name="subject" type="text" required placeholder="Enter your subject*">
            </div>
            <div class="col-md-6" style="border:solid">
        ...
        <textarea name="message" class="col-md-6" id="message" placeholder="Enter your massage*" style="border:solid" ></textarea>
