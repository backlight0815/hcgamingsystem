...
@section('title')
Portfolio | HC_Gaming Studio Websites
                    ...
                    <div class="breadcrumb__wrap__content">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Portolio List</li>
                            </ol>
                        </nav>
                    </div>
                </div>
...
@foreach($portfolio as $item)
       ...
       <img src="{{ asset($item->portfolio_image) }}" style="height:600px" alt="">
                                </a>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-10">
                            <div class="portfolio__inner__content">
                                <h2 class="title"><a href="{{ route('portfolio.details',$item->id) }}">
                                    {{ ($item->portfolio_title) }}</a></h2>
